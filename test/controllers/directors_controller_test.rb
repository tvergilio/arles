...
class DirectorsControllerTest < ActionController::TestCase
  ...
  test "should create director" do
    assert_difference('Director.count') do
      post :create, director: { company_id: @director.company_id, forename: @director.forename, surname: @director.surname }
    end
  ...
  test "should update director" do
    patch :update, id: @director, director: { company_id: @director.company_id, forename: @director.forename, surname: @director.surname }
    assert_redirected_to director_path(assigns(:director))
  end
